...
double T_branch[MAX_NUM_DETTYPES][MAX_NUM_DET],E_branch[MAX_NUM_DETTYPES][MAX_NUM_DET]; //AIS original, also you can use Double_t
int    M_branch[MAX_NUM_DETTYPES],
      MULT_branch;
...
// int TRACE_branch[MAX_NUM_DETTYPES][MAX_NUM_DET][500];
std::vector<std::vector<std::vector<int>>> TRACE_branch;//Let's use a vector, Victor
